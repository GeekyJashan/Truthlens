...
import { a as getDefaultExportFromCjs, c as commonjsGlobal } from '../../../_commonjsHelpers-Dr0z5XX9.js';
...
class AbstractLiveClient extends AbstractClient {
    ...
    connect(transcriptionOptions, endpoint) {
         ...
         */
        import('../../../browser-CXnV6iwJ.js').then(function (n) { return n.b; }).then(({ default: WS }) => {
...
function useDeepgramSpeechRecognition({ apiKey, onSpeechRecognized, deepgramOptions, }) {
    ...
    const recognitionRef = useRef(new DeepgramSpeechRecognition());
...
export { useDeepgramSpeechRecognition };
